      ...
      <div className="relative z-10 w-full max-w-5xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <div className="mt-6 text-center text-sm text-gray-600 dark:text-gray-400">
            Don't have an account? <button type="button" onClick={() => { toggleAuth(); router.push('/signup'); }} className="text-saffron font-semibold hover:text-saffron-dark transition-colors">Request Now</button>
          </div>
        </div>
      </div>
    </div>
